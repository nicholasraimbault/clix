...
- Local history was sanitized with git-filter-repo 2.47.0. All 44 original
  commits and two new commits remain, preserving their messages and authors.
...
The [current build-source manifest](evidence/2026-09-12/source-sha256.json) identifies
the source checked during this pass. Compared with the earlier installed-build
...
The disclosure scan covered all 46 reachable commits, 228 blobs and 71 tracked
...
- The owner still needs to select a license; no license has been silently assigned.
